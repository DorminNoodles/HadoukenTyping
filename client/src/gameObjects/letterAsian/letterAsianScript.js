...
import LetterScript from '../../letterScript';


class LetterAsianScript extends LetterScript {

	constructor(position, letter, gameObject) {
		super(position, letter, gameObject);
	}
}


// class LetterAsianScript extends Script {
//
// 	constructor(position, letter, gameObject) {
// 		super();
...
export default LetterAsianScript;
